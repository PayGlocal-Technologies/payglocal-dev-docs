...
<Note>
  The GL-xxx reason code reference has moved to [Response Codes & Errors](/reference/response-codes-and-errors#gl-reason-codes). The page below is kept for backwards compatibility.
</Note>
