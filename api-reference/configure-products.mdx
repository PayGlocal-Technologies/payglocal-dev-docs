...
Configures which payment products to enable for the merchant and sets the fee structure for each. Must be completed **before** triggering [Verify Merchant](/api-reference/verify-merchant).
