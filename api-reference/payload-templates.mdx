...
<CardGroup cols={2}>
  <Card title="Response Handling Guide" icon="arrow-right-from-bracket" href="/payments/webhooks/handle-callback">
  ...
  <Card title="Payment Flow" icon="shield" href="/payments/lifecycle/request-signing">
