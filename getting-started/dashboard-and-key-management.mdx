...
<Steps>
  ...
  <Step title="Click your profile icon and open TID Details">
    ...
    <div className="payg-screenshot-tile payg-screenshot-tile--zoom">
      <img src="/images/dashboard/mid-step1-profile-click.png" alt="Click Profile Icon - Step 1" />
    </div>
    
    From the headings, click on **TID Details**.
    
    <div className="payg-screenshot-tile payg-screenshot-tile--zoom">
      <img src="/images/dashboard/mid-step2-tid-details.png" alt="TID Details - Step 2" />
    </div>
  </Step>
...
<Steps>
  <Step title="Navigate to Key Management System">
    ...
    <div className="payg-screenshot-tile payg-screenshot-tile--zoom">
      <img src="/images/dashboard/key-mgmt-step1-configure.png" alt="Navigate to Configure" />
    </div>
  ...
  <Step title="Download PayGlocal's Public Key">
    ...
    <div className="payg-screenshot-tile payg-screenshot-tile--zoom">
      <img src="/images/dashboard/key-mgmt-step2-download-public.png" alt="Download PayGlocal Public Key" />
    </div>
...
<Steps>
  <Step title="Filter by Key Type">
    ...
    <div className="payg-screenshot-tile payg-screenshot-tile--zoom">
      <img src="/images/dashboard/private-key-step1-filter.png" alt="Click on Key Type filter" />
    </div>
  </Step>
  <Step title="Select RSA">
    ...
    <div className="payg-screenshot-tile payg-screenshot-tile--zoom">
      <img src="/images/dashboard/private-key-step2-select-rsa.png" alt="Select RSA from dropdown" />
    </div>
  ...
  <Step title="Generate RSA Key">
    ...
    <div className="payg-screenshot-tile payg-screenshot-tile--zoom">
      <img src="/images/dashboard/private-key-step3-generate.png" alt="Click Generate RSA Key" />
    </div>
...
<Steps>
  ...
  <Step title="View the filename">
    ...
    <div className="payg-screenshot-tile payg-screenshot-tile--zoom">
      <img src="/images/dashboard/public-key-id-filename.png" alt="Public Key ID in filename" />
    </div>
  </Step>
...
<Steps>
  ...
  <Step title="Copy the Key ID from the table">
    ...
    <div className="payg-screenshot-tile payg-screenshot-tile--zoom">
      <img src="/images/dashboard/private-key-id-dashboard.png" alt="Copy Private Key ID from dashboard" />
    </div>
