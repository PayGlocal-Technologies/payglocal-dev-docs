...
<Warning>Always verify the webhook signature before processing the payload. Skipping this step allows forged webhook delivery.</Warning>
...
<Note>PayGlocal retries failed webhook deliveries up to 3 times with exponential backoff (1 minute, 5 minutes, 30 minutes). Ensure your endpoint returns HTTP 200 within 10 seconds.</Note>
