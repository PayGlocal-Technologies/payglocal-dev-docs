...
<Note>
  Standing Instructions are supported for **international cards only**. Available for both [Checkout Flow (PayCollect)](/payments/paycollect/overview) and [Seamless Flow (PayDirect)](/payments/paydirect/overview) integrations.
</Note>
