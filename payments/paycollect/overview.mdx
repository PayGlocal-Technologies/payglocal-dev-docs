---
title: "Checkout Flow (PayCollect)"
...
<CardGroup cols={3}>
  <Card title="JWT Authentication" icon="key" color="#1A6FE8" href="/payments/paycollect/api-quickref">
...
<Card title="CodeDrop — Modal, Drawer, or Inline" icon="square-code" href="/payments/paycollect/codedrop">
