...
<CardGroup cols={3}>
  <Card title="JWT Authentication" icon="key" color="#1A6FE8" href="/payments/paydirect/api-quickref">
...
<CardGroup cols={2}>
  <Card title="View Payment Methods" icon="layer-group" href="/payments/paydirect/api-quickref">
