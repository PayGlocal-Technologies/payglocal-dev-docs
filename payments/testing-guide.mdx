...
For the full key setup process, see [Key Management Overview](/set-up/keys/overview).
...
See [Merchant Requirements](/set-up/partner-onboarding/merchant-requirements) and [Sandbox Testing](/payments/testing-guide) for the full go-live process.
