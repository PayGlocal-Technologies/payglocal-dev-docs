...
<Steps>
  ...
  <Step title="Trigger Merchant Verification">
    ...
    Generates a unique `redirectLink` for the merchant to complete VKYC, DigiLocker document verification, and T&C acknowledgement. Embed this URL in an iFrame — see the [iFrame Integration](/set-up/partner-onboarding/iframe-integration) guide.
