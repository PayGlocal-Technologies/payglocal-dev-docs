...
<Note>
  In UAT, use bank account `1234567890` and IFSC `SBIN0000000` for successful penny drop. Any other combination triggers a `CANCELLED_CHEQUE` pendency. See [Sandbox Testing](/payments/testing-guide#partner-onboarding-bank-verification).
</Note>
